...
import { TurnContext, Middleware, ActivityTypes, Activity, StatePropertyAccessor } from 'botbuilder-core';
import { Menu } from './menu';
import { MenuManager, MenuMap, MenuContext } from './menuManager';

export class ManageMenusMiddleware implements Middleware {
    private readonly menus: MenuMap = {};

    constructor(private menuState: StatePropertyAccessor<object>, ...menus: Menu[]) { 
