...
class Menu {
    ...
    onRenderCards(context, choices, settings, cards) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const key in output) {
                list.push({ contentType: botbuilder_core_1.CardFactory.contentTypes.heroCard, content: output[key] });
            }
            // Render cards as a carousel
            const msg = botbuilder_core_1.MessageFactory.carousel(list);
    ...
    findTopChoice(context, choices, settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const found = botbuilder_dialogs_1.findChoices(utterance, choices, recognizeOptions);
...
function toActions(choices) {
    return choices.map((c) => {
        return c.action ? c.action : { type: botbuilder_core_1.ActionTypes.ImBack, title: c.title || c.value, value: c.value, image: c.image };
    });
}
