 ...
 */
import { BotAdapter, TurnContext, Activity, ConversationReference, ResourceResponse } from 'botbuilder-core';
/**
...
export declare class HttpAdapter extends BotAdapter {
     ...
     */
    processActivity(req: IncomingRequest, res: IncomingResponse, logic: (context: TurnContext) => Promise<any>): Promise<void>;
    /**
