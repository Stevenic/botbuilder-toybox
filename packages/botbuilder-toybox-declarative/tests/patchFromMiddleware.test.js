...
const { TurnContext, TestAdapter } = require('botbuilder-core');
const { PatchFromMiddleware } = require('../lib');

describe('PatchFromMiddleware', function() {
    this.timeout(5000);
