 ...
 */
export declare type FilterActivityHandler = (context: TurnContext, next: () => Promise<void>) => Promise<void>;
/**
 * :package: **botbuilder-toybox-extensions**
 *
 ...
 * ```
 */
export declare class FilterActivityMiddleware implements Middleware {
    private type;
    private handler;
    /**
