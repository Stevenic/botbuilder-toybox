 ...
 */
export declare type VersionChangedHandler = (context: TurnContext, version: number, next: () => Promise<void>) => Promiseable<void>;
/**
 * :package: **botbuilder-toybox-extensions**
 *
 ...
 * ```
 */
export declare class CheckVersion implements Middleware {
